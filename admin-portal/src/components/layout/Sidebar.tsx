  ...
  return (
    <aside className="flex h-screen w-60 shrink-0 flex-col bg-fps-primary select-none">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        ...
        <NavItem href="/field-data/visits" label="Crop Intelligence Module" icon={Sprout} active={isActive("/field-data/visits")} />
        <NavItem href="/field-data/mandi" label="Market Intelligence Module" icon={Store} active={isActive("/field-data/mandi")} />
        <NavItem href="/field-data/demos" label="Product Performance Module" icon={FlaskConical} active={isActive("/field-data/demos")} />

        <p className="text-[10px] font-bold uppercase tracking-widest text-white/30 px-3 mt-4 mb-2">
          Intelligence
        </p>
        <NavItem href="/map" label="Agri Map" icon={Globe} active={isActive("/map")} />
      </nav>
